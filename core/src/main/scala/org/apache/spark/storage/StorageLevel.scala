...
class StorageLevel private(
  ...
  private def this(flags: Int, replication: Int) {
    this((flags & 8) != 0, (flags & 4) != 0, (flags & 2) != 0, (flags & 1) != 0, replication, (flags & 16) != 0)
  }
  ...
  if(global){
    require(useOffHeap, "global is only used for off-heap storage")
  }

  override def clone(): StorageLevel = {
    new StorageLevel(useDisk, useMemory, useOffHeap, deserialized, replication, global)
  }
  ...
  override def toString: String = {
    s"StorageLevel($useDisk, $useMemory, $useOffHeap, $deserialized, $replication, $global)"
  }
...
object StorageLevel {
  ...
  val OFF_HEAP_GLOBAL = new StorageLevel(false, false, true, false, 1, true)
  ...
  def fromString(s: String): StorageLevel = s match {
    ...
    case "OFF_HEAP_GLOBAL" => OFF_HEAP_GLOBAL
