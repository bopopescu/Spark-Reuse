...
private[sql] trait SQLConf {
  ...
  //@transient  zengdan delete transient
  protected[spark] val settings = java.util.Collections.synchronizedMap(
  ...
  private[spark] def numShufflePartitions: Int = getConf(SHUFFLE_PARTITIONS, "2").toInt
